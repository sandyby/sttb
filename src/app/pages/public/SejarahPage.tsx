  ...
  return (
    <div ref={ref} className="relative pt-28 pb-28 min-h-[520px] flex items-center overflow-hidden bg-[#060C1A]">
      <motion.div style={{ y: yBg }} className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1716625862188-f421d41bfb66?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80"
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }} className="relative">
              <div className="rounded-2xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1763477950484-12fd6f42c67e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80" alt="Kampus STTB" className="w-full h-80 object-cover" />
              </div>
