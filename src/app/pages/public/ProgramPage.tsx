...
export function ProgramPage() {
  ...
  // Extract slug from pathname, e.g. "/sarjana-teologi" → "sarjana-teologi"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-20">
        <div className="text-center">
          <h1 className="text-gray-900 dark:text-white mb-3">Program tidak ditemukan</h1>
          <Link to="/" className="text-[#E62129]">Kembali ke Beranda</Link>
        </div>
      </div>
    );
  }
