...
import { Upload, Search, Trash2, Copy, Grid, List, Image, FileText, Film, Music, Filter, CheckCircle } from "lucide-react";
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 flex-shrink-0 flex items-center justify-center">
                          {item.type === "image" ? <img src={item.url} alt="" className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} /> : <Icon className="w-5 h-5" style={{ color: typeColors[item.type] }} />}
                        </div>
