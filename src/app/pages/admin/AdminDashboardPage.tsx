...
import { Newspaper, Calendar, Image, Users, TrendingUp, Eye, ArrowRight, Plus } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
          <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-gray-800">
            ...
            <Link to="/admin/news" className="text-[#E62129] text-xs hover:underline flex items-center gap-1">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
              ...
              <Link to="/admin/events" className="text-[#E62129] text-xs hover:underline">
                Lihat Semua
              </Link>
            </div>
            <div className="divide-y divide-gray-50 dark:divide-gray-800">
