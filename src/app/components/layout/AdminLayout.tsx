    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      ...
      >
        ...
        <div className="px-4 py-4 border-b border-white/10 flex items-center justify-between">
          <Link to="/admin/dashboard" className="flex items-center gap-2.5" onClick={closeSidebar}>
        ...
        <nav className="flex-1 py-3 px-3 overflow-y-auto space-y-1">
          ...
          <ul className="space-y-0.5">
            <li>
              <Link to="/admin/news/create" onClick={closeSidebar}
            ...
            <li>
              <Link to="/admin/events/create" onClick={closeSidebar}
                className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium text-blue-100/70 hover:bg-white/10 hover:text-white transition-all">
      ...
      <div className="flex-1 lg:ml-60 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center gap-3 shadow-sm">
          ...
          <div className="flex items-center gap-1.5 text-sm flex-1">
            <Link to="/admin/dashboard" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors hidden sm:inline">Admin</Link>
            {breadcrumb.parent && (
              <>
