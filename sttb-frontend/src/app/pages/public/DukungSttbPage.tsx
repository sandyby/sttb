...
import {
  Heart, BookOpen, Building2, ChevronDown, ChevronUp,
...
const priorities = [
  {
    ...
    detail: "Dukungan beasiswa terbuka bagi mahasiswa yang sudah menjalani proses belajar sampai dengan semester ke-2 dengan minimal IPK 3,0 dan telah lulus proses seleksi serta wawancara dengan Tim Beasiswa sebelumnya.",
    link: "/beasiswa",
  },
  {
    id: "perpustakaan",
    ...
    detail: "Melalui provider Ebscohost, saat ini STTB memiliki e-library yang berisi koleksi e-books yang relevan untuk pendidikan teologi dan juga berlangganan akses terhadap database jurnal ATLA. Koleksi e-books tersebut dapat dimanfaatkan oleh dosen, mahasiswa, dan alumni.",
    link: "/perpustakaan",
  },
  {
    id: "lain",
    ...
    detail: "Berbagai perencanaan ke depan telah dipersiapkan: pembangunan, digital ministry, pembuatan studio rekaman video dan audio, pembinaan hamba-hamba Tuhan di daerah-daerah, pelaksanaan seminar di tempat-tempat terpilih.",
    link: "/fasilitas",
  },
];
            ...
            <FadeIn direction="left">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Kontribusi Anda dapat menolong STTB melanjutkan amanat Kristus untuk
                  mempersiapkan dan mendidik pelayan-pelayan Tuhan yang sangat dibutuhkan
                  untuk menjawab tantangan zaman — agar menjadi pelayan-pelayan Tuhan yang
                  berdampak bagi masyarakat.
                </p>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  STTB sebagai Sekolah Tinggi yang terbuka bagi siapapun yang terpanggil
                  untuk mau diperlengkapi, dibentuk dan dididik melalui program Studi S1
                  dan S2.
                </p>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Dukungan Bapak/Ibu akan sangat membantu biaya studi mahasiswa yang
                  memiliki kendala finansial, peningkatan sumber daya, kualitas pendidik
                  dan pendidikan, serta menunjang fasilitas teknologi pembelajaran.
                </p>
              </div>
            </FadeIn>
                ...
                <StaggerItem key={p.id}>
                  <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-shadow h-full flex flex-col">
                    <div className="relative h-44 overflow-hidden">
                      ...
                      <div className={`absolute bottom-4 left-4 w-10 h-10 rounded-xl ${p.color} flex items-center justify-center`}>
                        <Icon className="w-5 h-5 text-white" />
                      </div>
                    </div>
                    <div className="p-5 flex-1 flex flex-col">
                      <h3 className="text-gray-900 dark:text-white font-bold mb-2">{p.title}</h3>
          ...
          <FadeIn>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Dengan segala kerendahan hati, kami mengundang Bapak/Ibu untuk menjadi
                rekan bagi pengembangan Kerajaan Allah dengan menginvestasikan
                pemimpin-pemimpin masa depan yang dapat mentransformasi kehidupan dan
                komunitas.
              </p>
            </div>
          </FadeIn>
            ...
            <div className="max-w-md mx-auto">
              <div className="bg-gradient-to-br from-[#0A2C74] to-[#0570CD] rounded-2xl p-6 text-white shadow-xl">
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <p className="font-bold text-lg">BCA — Surya Sumantri</p>
                ...
                <p className="text-blue-300 text-xs text-center">
                  {copied ? "✓ Nomor rekening disalin!" : "Klik ikon salin untuk menyalin nomor rekening"}
                </p>
              ...
              {/* QR Code placeholder */}
              <div className="mt-4 bg-gray-50 dark:bg-gray-800 rounded-xl p-4 text-center border border-gray-100 dark:border-gray-700">
                <div className="w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto mb-3 flex items-center justify-center">
                  <p className="text-gray-400 dark:text-gray-500 text-xs">QR Code</p>
                </div>
        ...
        <section className="py-14 bg-[#E62129]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-red-100 max-w-xl mx-auto leading-relaxed mb-6">
              Bagi STTB, kontribusi Bapak/Ibu sangat penting. Seberapapun nilainya akan
              sangat menolong kehidupan mahasiswa dan STTB.
            </p>
            <Link
              to="/kontak-kami"
