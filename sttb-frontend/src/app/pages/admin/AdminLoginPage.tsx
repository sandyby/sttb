...
export function AdminLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      if (data.email === "admin@sttb.ac.id" && data.password === "admin123") {
        ...
        toast.error("Email atau password salah. Coba: admin@sttb.ac.id / admin123");
      }
    } catch {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0A2C74] via-[#0A2C74] to-[#0570CD] p-12 flex-col justify-between relative overflow-hidden">
        {/* Decorations */}
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <div className="text-white font-bold text-lg">STTB</div>
          ...
          <p className="text-blue-200 leading-relaxed max-w-sm">
            Masuk untuk mengelola konten website STTB — berita, kegiatan, media,
            dan halaman statis.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <div className="w-10 h-10 rounded-full bg-[#E62129] flex items-center justify-center text-white font-bold">
              S
            </div>
            <div>
              <div className="text-gray-900 dark:text-white font-bold">STTB Admin</div>
              <div className="text-gray-500 text-xs">Portal Manajemen</div>
            </div>
          </div>
