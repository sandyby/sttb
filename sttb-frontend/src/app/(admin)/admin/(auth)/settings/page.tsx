                                ...
                                <div className="flex items-center gap-4 flex-wrap">
                                    {[
                                        ...
                                        <div key={c.key} className="flex items-center gap-2">
                                            {/* // TODO: fix typescript misconfiguration, umum masih unknown */}
                                            <input type="color" value={(umum as unknown as Record<string, string>)[c.key]} onChange={(e) => setUmum((u) => ({ ...u, [c.key]: e.target.value }))} className="w-8 h-8 rounded cursor-pointer border border-gray-200" />
