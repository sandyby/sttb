  ...
  const stats = [
    {
      ...
      icon: Newspaper,
      color: "bg-red-50 dark:bg-red-900/20 text-[#E62129]",
      change: "+3 bulan ini",
    },
    {
      ...
      icon: Calendar,
      color: "bg-blue-50 dark:bg-blue-900/20 text-[#0A2C74]",
      change: "+2 minggu ini",
    },
    {
      label: "Media Files",
      ...
      icon: LucideImage,
      color: "bg-sky-50 dark:bg-sky-900/20 text-[#0570CD]",
      change: "+5 bulan ini",
    },
    {
      label: "Pengunjung/Bulan",
      value: dashboardStats.visitors,
      icon: Eye,
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
          <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-gray-800">
            ...
            <Link
              href="/admin/news"
              className="text-[#E62129] text-xs hover:underline flex items-center gap-1"
            >
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-800 min-h-[300px]">
            {isLoading ? (
              ...
              recentNews.map((article: NewsListItem) => (
                <div
                  key={article.id}
