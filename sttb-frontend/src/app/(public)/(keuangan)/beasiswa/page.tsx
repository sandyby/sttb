...
const faqs = [
  {
    q: "Apakah STTB menyediakan beasiswa bagi mahasiswa?",
    a: "Ya, STTB menyediakan beasiswa bagi mahasiswa S1 dan S2.",
  },
  {
    q: "Apa saja jenis beasiswa yang STTB tawarkan?",
    a: "Ada 3 jenis beasiswa: Pastor Scholar, Formatio, dan Transformative Leadership. Mahasiswa dapat mengajukan sesuai kriteria yang ditentukan.",
  },
  {
  ...
  {
    q: "Bagaimana cara saya mendaftar aplikasi beasiswa?",
    a: "Pendaftaran beasiswa dilakukan dengan mengunduh form aplikasi beasiswa yang disediakan serta melampirkan syarat-syarat yang ditentukan. Form beasiswa dapat diunduh di www.sttb.ac.id.",
  },
  {
    q: "Kapan saya bisa mengirim aplikasi beasiswa?",
    a: "Aplikasi beasiswa dapat dikirimkan setiap saat selambat-lambatnya 3 minggu sebelum proses pendaftaran periode ditutup.",
  },
  {
    q: "Apakah saya bisa kehilangan beasiswa selama masa studi?",
    a: "Bisa, jika hasil evaluasi setiap semester tidak mendukung, maka beasiswa akan dihentikan.",
  },
  {
    q: "Jika tidak lolos seleksi, apakah bisa mengajukan lagi?",
    a: "Ya, jika mahasiswa yang pernah mengajukan beasiswa namun tidak berhasil, masih dapat mengajukan di periode berikutnya.",
  },
];
    ...
    <div className="border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden">
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <p className="px-4 py-3 text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              {a}
            </p>
          </motion.div>
        )}
          ...
          <FadeIn>
            <div className="text-center mb-10">
              <p className="text-[#E62129] text-sm font-semibold uppercase tracking-wider mb-2">
                {isLoading
                  ? "Memuat Data..."
                  : `${scholarships.length} Jenis Beasiswa`}
              </p>
              <h2
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl transition-shadow">
                    <div className="grid md:grid-cols-5">
                      <div className="md:col-span-2 relative h-48 md:h-auto">
                        {s.imageUrl ? (
                          <Image
                            src={getImageUrl(s.imageUrl) ?? s.imageUrl}
                            alt={s.name}
                            fill
            ...
            <FadeIn direction="right">
              <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-xl p-6">
                ...
                <p className="text-amber-700 dark:text-amber-400 text-sm leading-relaxed mb-3">
                  Bagi penerima beasiswa yang melanggar ketentuan dan peraturan
                  STTB serta mendapatkan Surat Peringatan:
                </p>
                <ul className="space-y-2">
                  {commonSanctions.map((s, i) => (
                    <li
                      key={i}
          ...
          <FadeIn delay={0.2}>
            <div className="bg-[#0A2C74] rounded-2xl p-6 text-white">
              ...
              <p className="text-blue-200 text-sm mb-5 leading-relaxed">
                Pemohon dapat mengunduh form aplikasi beasiswa, melengkapinya,
                dan mengirim melalui email ke{" "}
                <a
