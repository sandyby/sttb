  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        points: [
          {
            label: "Formasi Pengajaran",
            desc: "Bertumbuh dalam pengenalan akan Tuhan dan firman-Nya",
          },
          {
            label: "Formasi Spiritual",
            desc: "Bertumbuh dalam hubungan pribadi dengan Tuhan",
          },
          {
            label: "Formasi Karakter",
            desc: "Bertumbuh dalam karakter serupa Kristus",
          },
          {
            label: "Formasi Pelayanan",
            desc: "Bertumbuh dalam pelayanan di dalam tubuh Kristus dan misi di tengah dunia",
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            label: "Short-term Ministry",
            desc: "Praktik Pelayanan Jangka Pendek",
          },
          {
            label: "Long-term Ministry",
            desc: "Praktik Pelayanan Jangka Panjang (1 Tahun)",
          },
        ],
      },
    ],
                        ...
                        {block.points.map((p) => (
                          <div
                            ...
                            style={{
                              ...
                              borderLeft: `3px solid ${active.color}40`,
                            }}
                          >
                            <div>
        ...
        <section className="py-14 bg-[#0A2C74]">
          <div className="max-w-3xl mx-auto px-4 text-center">
            <p className="text-blue-200 text-lg leading-relaxed italic mb-4">
              &quot;Kapel merupakan kegiatan penting dalam kehidupan di kampus
              secara komunitas dan wajib diikuti. Di dalam kapel kita
              mendengarkan Firman Tuhan dan berdoa bersama, belajar memimpin
              ibadah dan menyampaikan Firman Tuhan, serta bergumul menangkap
              visi dan misi bagi pelayanan selanjutnya.&quot;
            </p>
