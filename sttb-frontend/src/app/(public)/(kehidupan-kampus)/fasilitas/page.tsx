...
const categories = [
  {
    ...
    detail:
      "Format ruang kelas didesain mengakomodasi berbagai format pembelajaran. Perpustakaan didesain agar nyaman dan instagramable. Ruang teleconference dan ruangan kelas lainnya siap pakai bagi pembelajaran hybrid (onsite-online). Dilengkapi pula dengan studio audio-visual Didasko — tempat produksi media pengajaran STTB sekaligus tempat belajar pelayanan media bagi mahasiswa.",
    image:
      "https://images.unsplash.com/photo-1758413350815-7b06dbbfb9a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
    gallery: [
      {
        url: "https://images.unsplash.com/photo-1741795746033-d50d48dc1da5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Perpustakaan",
      },
      {
        url: "https://images.unsplash.com/photo-1761850215840-2775d7229cad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Studio Didasko",
      },
      {
        url: "https://images.unsplash.com/photo-1758413350815-7b06dbbfb9a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Ruang Kelas",
      },
    ],
  },
  {
    ...
    detail:
      "STTB menyediakan fasilitas pendukung pertumbuhan rohani: ruang konseling pribadi dan konseling kelompok, beberapa tempat pertemuan hangout kelompok kecil, aula untuk pertemuan ibadah/seminar dengan audiens besar, serta fasilitas di luar kampus berupa rumah retreat — Rumah Doa Bethel.",
    image:
      "https://images.unsplash.com/photo-1763410723546-db98ef034af5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
    gallery: [
      {
        url: "https://images.unsplash.com/photo-1763410723546-db98ef034af5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Kapel & Aula Ibadah",
      },
      {
        url: "https://images.unsplash.com/photo-1627252500796-aae30da38937?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Ruang Kelompok Kecil",
      },
      {
        url: "https://images.unsplash.com/photo-1696238572906-2a85322d2152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Komunitas Bersama",
      },
    ],
  },
  {
    ...
    highlights: [
      ...
      {
        icon: Dumbbell,
        text: "Basket · Badminton · Futsal · Renang · Tenis Meja",
      },
    ],
    detail:
      "Ada empat asrama terintegrasi di lokasi kampus STTB: asrama dosen, asrama mahasiswa putra (aspra), asrama mahasiswa putri (aspri), dan asrama mahasiswa pascasarjana/tamu. Fasilitas asrama terdiri dari kamar tidur lengkap, kamar mandi dan toilet, lounge, ruang makan, serta berbagai sarana olahraga.",
    image:
      "https://images.unsplash.com/photo-1759200135568-566eb9ecaa81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
    gallery: [
      {
        url: "https://images.unsplash.com/photo-1696238572906-2a85322d2152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Asrama Mahasiswa",
      },
      {
        url: "https://images.unsplash.com/photo-1759200135568-566eb9ecaa81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Fasilitas Olahraga",
      },
      {
        url: "https://images.unsplash.com/photo-1758936382103-c1dbffcea2ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
        label: "Lapangan & Area Outdoor",
      },
    ],
  },
];
...
const galleryImages = [
  ...
  {
    url: "https://images.unsplash.com/photo-1761850215840-2775d7229cad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Studio Audio-Visual Didasko",
    tag: "Akademik",
  },
  {
    url: "https://images.unsplash.com/photo-1606761568499-6d2451b23c66?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Aula Seminar",
    tag: "Rohani",
  },
  {
    url: "https://images.unsplash.com/photo-1763410723546-db98ef034af5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Kapel & Ruang Ibadah",
    tag: "Rohani",
  },
  {
    url: "https://images.unsplash.com/photo-1627252500796-aae30da38937?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
  ...
  {
    url: "https://images.unsplash.com/photo-1762383805537-a5e222f79c8f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Rumah Doa Bethel",
    tag: "Rohani",
  },
  {
    url: "https://images.unsplash.com/photo-1696238572906-2a85322d2152?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
  ...
  {
    url: "https://images.unsplash.com/photo-1763890763377-abd05301034d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Komunitas Kampus",
    tag: "Residensial",
  },
  {
    url: "https://images.unsplash.com/photo-1687709645238-0470ff08a6bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Ruang Makan Bersama",
    tag: "Residensial",
  },
  {
    url: "https://images.unsplash.com/photo-1770306029966-e43683aced03?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
  ...
  {
    url: "https://images.unsplash.com/photo-1758936382103-c1dbffcea2ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Area Outdoor Kampus",
    tag: "Olahraga",
  },
  {
    url: "https://images.unsplash.com/photo-1769509068789-f242b5a6fc47?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Studio Podcast",
    tag: "Akademik",
  },
  {
    url: "https://images.unsplash.com/photo-1762185941323-326e8e39af98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Koleksi Buku Teologi",
    tag: "Akademik",
  },
  {
    url: "https://images.unsplash.com/photo-1769021045407-d49e26aebcba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Gedung Kampus",
    tag: "Kampus",
  },
  {
    url: "https://images.unsplash.com/photo-1732115234692-3ee71d5363af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80",
    label: "Area Kampus STTB",
    tag: "Kampus",
  },
];
        ...
        >
              ...
              {cat.highlights.map((h, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-gray-700 dark:text-gray-300 text-xs leading-snug font-medium">
                      {h.text}
                    </span>
                  </motion.div>
                );
          ...
          >
            ...
            <div
              ...
              style={{ height: "300px" }}
              onClick={() =>
                setLightboxImg({ url: cat.image, label: cat.label })
              }
            >
              <Image
                src={cat.image}
      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto leading-relaxed mb-8">
            Semua fasilitas ini dirancang untuk mengoptimalkan proses
            pembentukan pribadi dan pemerlengkapan pelayanan mahasiswa STTB —
            agar siap melayani di gereja, masyarakat, dan dunia.
          </p>
      ...
      <section className="py-14 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            >
              &quot;Fasilitas-fasilitas di kampus dan asrama STTB dirancang
              untuk{" "}
              <strong className="text-[#E62129] not-italic">
                mengoptimalkan proses pembentukan pribadi
              </strong>{" "}
              dan pemerlengkapan pelayanan mahasiswa. Sepanjang masa studi,
              mahasiswa akan{" "}
              <strong className="text-[#0A2C74] dark:text-blue-300 not-italic">
                belajar bersama, bertumbuh bersama, dan hidup bersama
              </strong>{" "}
              dalam komunitas.&quot;
            </blockquote>
          </motion.div>
      ...
      {categories.map((cat, i) => (
        <div id={cat.id} key={cat.id}>
          ...
          {i < categories.length - 1 && (
            <SectionDivider color={categories[i + 1].color} />
          )}
        </div>
      ))}
