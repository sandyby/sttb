                                    ...
                                    <div className="space-y-1">
                                        {formats.map((f) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${activeFormat === f
                                    ...
                                    <div className="space-y-1">
                                        {categories.map((c) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-3 py-1.5 rounded-lg text-xs transition-colors ${activeCategory === c
                                            ...
                                            >
                                                <div className="relative overflow-hidden">
                                                    ...
                                                    <div className="absolute top-3 left-3 flex gap-1.5">
                                                        <span
                                                            className={`px-2 py-0.5 rounded text-white text-xs font-medium ${item.format === "Video"
                                                                ? "bg-[#E62129]"
                                                                : "bg-[#0A2C74]"
                                                                }`}
                                                        >
