...
function LeaderCard({
  ...
  const accentGrad =
    index === 0 ? "from-[#E62129] to-[#0A2C74]" : "from-[#0A2C74] to-[#0570CD]";

  const imgSrc =
    getImageUrl(person.imageUrl) ?? "https://placehold.co/600x800/png";
    ...
    >
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm group-hover:shadow-2xl transition-all duration-500">
        ...
        <div className="flex flex-col sm:flex-row">
          <div
            className="relative sm:w-56 lg:w-64 flex-shrink-0 overflow-hidden"
          ...
          <div className="flex-1 p-6 lg:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <span
                  className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs text-white bg-gradient-to-r ${accentGrad}`}
              ...
              <h3
                className="text-gray-900 dark:text-white mb-1 leading-tight"
              ...
              <div className="flex flex-wrap gap-1.5">
                {person.courses.slice(0, 3).map((c) => (
                  <span
                    key={c}
                    className="px-2.5 py-0.5 rounded-full bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 text-xs border border-gray-100 dark:border-gray-700"
                  >
                    {c}
                  </span>
                ))}
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm group-hover:shadow-xl group-hover:border-gray-200 dark:group-hover:border-gray-700 transition-all duration-400">
        <div className="relative overflow-hidden" style={{ height: "210px" }}>
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(10,44,116,0.9) 0%, rgba(10,44,116,0.35) 60%, transparent 100%)",
            }}
          >
          ...
          {isNotTetap && (
            <div className="absolute top-3 left-3">
              <span
                className="bg-[#0570CD]/90 backdrop-blur-sm text-white text-xs px-2.5 py-1 rounded-full"
        ...
        <div className="p-4">
          <span
            className="inline-block px-2 py-0.5 rounded text-xs mb-2 bg-[#E62129]/8 text-[#E62129]"
            style={{ fontWeight: 600 }}
          >
            {person.title}
          </span>
          <h3
            className="text-gray-900 dark:text-white text-sm leading-snug mb-1.5"
            style={{ fontWeight: 700 }}
          >
            {person.name}
          </h3>
          <p
            className="text-[#0570CD] dark:text-blue-400 text-xs flex items-center gap-1 mb-1.5"
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(90deg, #E62129, #0A2C74, #0570CD)",
            ...
            <div className="flex flex-col sm:flex-row h-full">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 sm:hidden">
                  <span
                    className="bg-[#E62129] text-white text-xs px-2.5 py-0.5 rounded-full"
                    style={{ fontWeight: 700 }}
                  >
                    {person.title}
                  </span>
              ...
              >
                ...
                <div className="p-5 space-y-4 flex-1">
                  <div>
                    <p className="text-gray-400 text-xs uppercase tracking-wider mb-1.5">
                      Profil
                    </p>
                  ...
                  {person.email && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          className="text-[#E62129] text-sm group-hover:underline"
                          style={{ fontWeight: 600 }}
                        >
                          {person.email}
                        </p>
...
export default function DewanDosenPage() {
  ...
  const { data, isLoading, error } = useGetLecturers({
    isActive: true,
    pageSize: 200,
  });
  ...
  return (
    <>
                  ...
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">
                        Pemimpin institusi STTB yang membentuk arah pendidikan
                        teologi
                      </p>
                    </div>
                  </div>
            ...
            <section className="py-16 bg-gray-50 dark:bg-gray-900">
              <div className="max-w-7xl mx-auto px-4">
                  ...
                  <FadeIn>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-xs">
                          Dosen tetap & tidak tetap berpengalaman di bidangnya
                        </p>
                      </div>
                    </div>
                  </FadeIn>
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-3 mb-8 scrollbar-hide">
                  <span className="text-gray-400 text-xs uppercase tracking-wider whitespace-nowrap flex-shrink-0">
                    Filter:
                  </span>
                    ...
                    {totalRegularPages > 1 && (
                      <div className="flex items-center justify-between mt-10">
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          {(regularPage - 1) * REGULAR_PAGE_SIZE + 1}–
                          {Math.min(
                            regularPage * REGULAR_PAGE_SIZE,
                            filteredRegular.length,
                          )}{" "}
                          dari {filteredRegular.length} dosen
                        </p>
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => {
                              setRegularPage((p) =>
                                Math.min(totalRegularPages, p + 1),
                              );
                              window.scrollTo({ top: 0, behavior: "smooth" });
                            }}
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #0A2C74, #060C1A)" }}
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute right-0 top-0 w-96 h-96 rounded-full bg-[#E62129]/5"
        ...
        <div className="max-w-3xl mx-auto px-4 text-center relative">
          ...
          >
            ...
            <p className="text-blue-200/70 leading-relaxed mb-6">
              STTB membuka kesempatan bagi para akademisi teologi yang
              berdedikasi untuk berkontribusi dalam misi mendidik pemimpin
              gereja Indonesia.
            </p>
            <a
