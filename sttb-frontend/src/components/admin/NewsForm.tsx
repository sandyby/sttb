...
function RichTextEditor({
  ...
  const apply = (action: string, wrap: boolean) => {
    ...
    onChange(newVal);
    const cur = wrap
      ? s + action.length + sel.length + action.length
      : s + action.length + sel.length;
    setTimeout(() => {
  ...
  const html = (t: string) =>
    t
      ...
      .replace(
        /^> (.*?)$/gm,
        "<blockquote class='border-l-4 border-gray-300 pl-3 italic text-gray-500 my-2'>$1</blockquote>",
      )
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        ...
        {TOOLBAR.map((btn) => {
          ...
          return (
            <button
              ...
              type="button"
              title={btn.label}
              onClick={() => apply(btn.action, btn.wrap)}
      ...
      {preview ? (
        <div
          className="min-h-[280px] p-5 text-sm text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900 prose prose-sm max-w-none"
      ...
      <div className="px-4 py-1.5 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 text-xs text-gray-400">
        {value.length} karakter · {value.split(/\s+/).filter(Boolean).length}{" "}
        kata
      </div>
    </div>
  );
    ...
    <div className="space-y-2">
      <div className="flex flex-wrap gap-1.5 min-h-[28px]">
        ...
        <input
          ...
          className="flex-1 min-w-20 text-sm bg-transparent text-gray-700 dark:text-gray-300 focus:outline-none placeholder-gray-400"
        />
      </div>
    ...
    <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              {isEdit
                ? "Perbarui konten berita yang sudah ada"
                : "Bagikan informasi terbaru kepada civitas akademik"}
            </p>
          </div>
        </div>
      ...
      {isEdit && (
        <div className="flex items-center gap-3 p-4 rounded-2xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800">
          ...
          <span
            className={`ml-auto px-2 py-0.5 rounded-full text-xs font-semibold ${statusValue === "published" ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400"}`}
          >
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            ...
            />
            {errors.title && (
              <p className="flex items-center gap-1 text-[#E62129] text-xs mt-1.5">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            ...
            <div className="flex justify-between mt-1">
              {errors.excerpt ? (
                <p className="flex items-center gap-1 text-[#E62129] text-xs">
                  <AlertCircle className="w-3 h-3" />
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-800">
                    ...
                    <button
                      ...
                      style={{
                        width: 40,
                        height: 22,
                        backgroundColor: field.value ? "#E62129" : "#D1D5DB",
                      }}
                    >
                      <span
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-xs text-gray-400 mb-1.5">
                  Kategori <span className="text-[#E62129]">*</span>
                </label>
                <select
                  {...register("categoryId")}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5">
            ...
            {coverImageUrl ? (
              ...
              <div
                ...
                className={`rounded-xl border-2 border-dashed p-5 text-center cursor-pointer transition-colors ${isUploading ? "border-blue-300 bg-blue-50/50 dark:bg-blue-900/20" : "border-gray-200 dark:border-gray-700 hover:border-[#E62129]"}`}
              >
                {isUploading ? (
                  <>
                  ...
                  <>
                    ...
                    <p className="text-[10px] text-gray-400 mt-0.5">
                      Hanya mendukung .jpg/.png (Max 10MB)
                    </p>
                  </>
                )}
              </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5 text-xs space-y-2">
            ...
            {[
              { label: "Judul", ok: !!titleValue },
              {
                ...
                ok: !!contentValue,
                extra: contentValue
                  ? `${contentValue.split(/\s+/).filter(Boolean).length} kata`
                  : "",
              },
