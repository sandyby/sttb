...
export function UploadMediaDialog({ isOpen, onClose }: UploadMediaDialogProps) {
  ...
  const handleFileSelect = (selectedFile: File | null) => {
    ...
    if (!isImage) {
      toast.error(
        "Format file tidak didukung. Mohon upload gambar untuk thumbnail.",
      );
      return;
    }
  ...
  const onSubmit = async (data: CreateMediaFormValues) => {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Gagal menambahkan media",
      );
    }
  };
                  ...
                  {!file ? (
                    ...
                    >
                      ...
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-200">
                        Klik untuk upload atau seret gambar kesini
                      </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      {form.formState.errors.title && (
                        <p className="text-[#E62129] text-xs mt-1">
