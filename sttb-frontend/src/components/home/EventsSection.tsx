...
import { useGetEvents, EventListItem } from "@/hooks/useEvents";
import Image from "next/image";
import { Skeleton } from "@/components/ui/skeleton";

function EventCardSkeleton() {
  return (
    <div className="flex flex-col bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800">
...
export function EventsSection() {
  const { data, isLoading, error } = useGetEvents(1, 4);
