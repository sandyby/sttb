  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/program-studi/sarjana-pendidikan-kristen",
      },
      {
      ...
      },
      {
        ...
        href: "/program-studi/magister-ministri-teologi-pelayanan-gerejawi",
      },
      {
        label: "Magister Pendidikan Kristen",
        href: "/program-studi/magister-pendidikan-kristen",
      },
      {
        label: "MMin – Marketplace",
        href: "/program-studi/magister-ministri-marketplace",
      },
      {
        label: "MMin – Kepemimpinan Pastoral",
        href: "/program-studi/magister-ministri-kepemimpinan-pastoral",
      },
      {
        label: "MTh – Transformasi Budaya & Masyarakat",
        href: "/program-studi/magister-teologi-transformasi-budaya-masyarakat",
      },
    ],
  },
  {
