...
export default function PageHeader({
  ...
  return (
    <div className={cn("relative w-full pt-32 pb-20 overflow-hidden bg-[#0A2C74]", className)}>
      {/* Parallax Background */}
      <motion.div 
        style={{ y }}
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-[#0A2C74]/95 via-[#0A2C74]/80 to-[#0570CD]/60" />
      </motion.div>
        ...
        >
          ...
          <div className="space-y-4">
            {category && (
              ...
              >
                <div className="w-8 h-1 bg-[#E62129]" />
                <span className="text-[#E62129] text-sm font-bold uppercase tracking-widest">
                  {category}
                </span>
              </motion.div>
            )}
