...
public class GetStudyProgramRequestBySlugHandler
    : IRequestHandler<GetStudyProgramBySlugRequest, GetStudyProgramResponse>
{
    private readonly ApplicationDbContext _dbContext;

    public GetStudyProgramRequestBySlugHandler(ApplicationDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<GetStudyProgramResponse> Handle(
        GetStudyProgramBySlugRequest request,
