...
public class UpdateEventRequestHandler : IRequestHandler<UpdateEventRequest>
{
    ...
    public async Task Handle(UpdateEventRequest request, CancellationToken cancellationToken)
    {
        ...
        eventEntity.IsOngoing = request.IsOnGoing;
        eventEntity.Location = request.Location ?? string.Empty;
        eventEntity.LocationDetails = request.LocationDetails;
        ...
        eventEntity.Mode = request.Mode;
        eventEntity.IsOnline = request.IsOnline;
        eventEntity.StreamingUrl = request.StreamingUrl;
