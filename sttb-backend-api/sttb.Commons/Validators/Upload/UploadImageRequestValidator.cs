...
{
    private static readonly string[] AllowedUploadTypes = { "news", "events", "media", "pages", "lecturers", "foundation" };
    ...
    public UploadImageRequestValidator()
    {
        ...
        RuleFor(x => x.UploadType)
            ...
            .WithMessage("UploadType must be 'news', 'events', 'media', 'pages', 'lecturers', or 'foundation' .");
    }
}
