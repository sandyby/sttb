...
{
    private static readonly string[] AllowedUploadTypes = { "news", "events", "media", "pages", "lecturers" };
    ...
    public UploadImageRequestValidator()
    {
        ...
        RuleFor(x => x.UploadType)
            ...
            .WithMessage("UploadType must be 'news', 'events', 'media', 'pages', or 'lecturers'.");
    }
}
